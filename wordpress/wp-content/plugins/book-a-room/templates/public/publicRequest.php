        ...
        <div id="topRow">
            <div class="col">
                <div class="instructionsSmooth">
                    ...
                    <p>
                        <?php _e( 'Completing the form does not immediately guarantee your reservation. You will be contacted at the email or phone number you supply to verify your registration.', 'book-a-room' ); ?>
                    </p>
