...
<div class="mainText">
	...
	<h3>
		<?php _e( 'Adding Checkboxes the User Must Check.', 'book-a-room' ); ?>
	</h3>
    
    <p>
		<?php _e( 'If you add the text <strong>#check#</strong> to the start of a line, it will be replaced by a generic checkbox when the user views the content.', 'book-a-room' ); ?>
	</p>
    <p>
		<?php _e( 'If you have one or more <strong>#check#</strong> on your page, the user will need to check them all before continuing.', 'book-a-room' ); ?>
	</p>
	<p>
