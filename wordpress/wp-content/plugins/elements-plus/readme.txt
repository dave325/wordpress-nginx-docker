...
Elements Plus! provides awesome custom widgets for the Elementor page builder. AudioIgniter, Button, Call to Action, Contact Form 7, Countdown, Dual Button, FlipClock, Gallery, Google Maps, Hotspots, Icon, Image Comparison, Image Hover Effects, Inline SVG, Instagram, Instagram Filters, Label, Preloader,Scheduled visibility, Search, Sticky Videos, Tables, Tilt Effect, Tooltip, WPForms and YouTube Slideshow widgets are available.

== Description ==
Elements Plus! is a plugin for the popular Elementor page builder. It gives the user twenty six extra 'elements' (widgets) to use.
